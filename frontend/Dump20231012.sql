...
INSERT INTO `autores` VALUES (1,'FEDERICO AXAT',6,'A'),(2,'GABRIEL ROLON',4,'A'),(3,'ESTANISLAO BACHRACH',2,'A'),(4,'PAULO COHELO',5,'A'),(5,'BRIAN TRACY',2,'A'),(66,'GARCIA MARQUEZ',5,'A');
...
INSERT INTO `editorial` VALUES (1,'MOTUS','A'),(2,'DE BOLSILLO','A'),(3,'OCEANO','A'),(4,'PLANETA DE LIBROS','A'),(5,'EL ATENEO','A'),(6,'DESTINO','A'),(27,'zas','A');
...
INSERT INTO `lectores` VALUES (5,'aaa','aaaa',2222,'aaaa@ss','A'),(6,'Juan','Perez',333333,'perez@gmail.com','A'),(8,'elpapa','francisco',11111,'elpapa@gmail','A'),(9,'sebastian','perez',38139594,'afffa@gmail','A');
...
INSERT INTO `libros` VALUES (1,'EL PANTANO DE LAS MARIPOSAS','A',9,1,1,'LIB123'),(2,'EN CAMBIO','A',2,5,3,'LIB222'),(3,'EL DUELO','A',2,2,2,'LIB333'),(9,'la ultima salida','A',9,1,1,NULL);
...
INSERT INTO `menu` VALUES (1,'Libros','/Libros',1),(2,'Editorial','/editorial',1),(3,'Autores','/autores',1),(5,'Usuarios','/usuarios',1),(7,'Libros','/libros',2),(9,'Lectores','/lectores',1),(10,'Lectores','/lectores',2),(11,'Prestamos','/prestamos',1),(12,'Prestamos','/prestamos',2);
...
INSERT INTO `prestamos` VALUES (1,6,2,'2023-10-10','2023-10-05','pendiente'),(2,6,3,'2023-10-09','2023-10-15','pendiente'),(6,9,2,'2023-10-11','2023-10-12','pendiente');
...
INSERT INTO `ubicaciones` VALUES (1,'ESTANTE mil','B'),(2,'ESTANTE 2','A'),(3,'ESTANTE 3','A'),(4,'ESTANTE 4','A'),(5,'ESTANTE 5','A');
...
INSERT INTO `usuarios` VALUES (1,'cristian','ramos','38139594','cramos','$2b$10$nyQRfMSJwSj3BNngbr0nm.MBqqZnDJe3E7K8CTa0IQ7cupdJuEVOK','cristian@gmail.com',1,'A'),(15,'ramos','sebastian','333333','sramos','$2b$10$QVHfcnSK.UeSMoB2zUoyxOEJHds5jL3Dfut/vcIZ/dWGOs5n.r5zK','asdfg@q',2,'A'),(16,'Cristian','Ramos','38139594','cristianramos','$2b$10$V9k7qXr0pKxL2kctJV6aYeCY1bJDbeE.cm81K1ZYVyBNEni5MCDdK','cristian@gmail.com',1,'A');
...
-- Dump completed on 2023-10-12 12:29:08
