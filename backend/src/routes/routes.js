                ...
                (error, usuarios) => {
                    if (error) {
                        ...
                        if (usuarios.length > 0) {
                            ...
                            mysqlConnect.query(
                                "INSERT INTO usuarios (apellido, nombre, dni, user, pass, correo, id_rol ) VALUES (?,?,?,?,?,?,?)",
                                [apellido, nombre, dni, user, hash, correo, id_rol],
                                (error, registros) => {
                                    if (error) {
                                        console.log(
                                            "Error en la base de datos al momento de insertar ----> ",
                                            error
                                        );
                                    } else {
                                        res.json({
